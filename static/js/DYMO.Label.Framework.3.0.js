...
(function () {
    ...
    function qa(a, b) {
        ...
        for (var e = a.length, g = t(a) ? a.split("") : a, h = 0; h < e; h++) if (h in g && b.call(d, g[h], h, a)) return !0;
        return !1
    };
    ...
    function va(a) {
        ...
        a:{
            b = wa;
            for (var d = a.length, e = t(a) ? a.split("") : a, g = 0; g < d; g++) if (g in e && b.call(void 0, e[g], g, a)) {
                b = g;
                break a
            }
            b = -1
    ...
    function Ab(a) {
        return new G(function (b, d) {
            ...
            if (e) for (var h = function (a, d) {
                ...
                d(a)
            }, l = 0, m; m = a[l]; l++) Bb(m, ja(h, l), k); else b(g)
        })
    }
    ...
    function ub(a, b, d) {
        if (a.c == sb) {
            if (a == d) b = H, d = new TypeError("Promise cannot resolve to itself"); else {
                if (cb(d)) {
                    a.c = 1;
                    Bb(d, a.la, a.ma, a);
                    return
    ...
    function Gb(a, b, d, e) {
        ...
        if (b.c) b.c.h = null, Kb(b, d, e); else try {
    ...
    Ub.prototype.f = function () {
        Ub.ca.f.call(this);
        var a = this.h;
        if (a.preventDefault) a.preventDefault(); else if (a.returnValue = !1, Rb) try {
    ...
    function $b(a, b, d, e, g, h) {
        ...
        b || (b = a.c[k] = [], a.f++);
        var l = ac(b, d, g, h);
        -1 < l ? (a = b[l], e || (a.$ = !1)) : (a = new Xb(d, a.src, k, !!g, h), a.$ = e, b.push(a));
        return a
    }
    ...
    function ac(a, b, d, e) {
        ...
        return -1
    };var cc = "closure_lm_" + (1E6 * Math.random() | 0), dc = {}, ec = 0;

    function fc(a, b, d, e, g) {
        if (ca(b)) for (var h = 0; h < b.length; h++) fc(a, b[h], d, e, g); else if (d = gc(d), a && a[Vb]) $b(a.D, String(b), d, !1, e, g); else {
            ...
            if (!d.c) {
                ...
                e.src = a;
                e.listener = d;
                if (a.addEventListener) a.addEventListener(b.toString(), e, h); else if (a.attachEvent) a.attachEvent(jc(b.toString()), e); else throw Error("addEventListener and attachEvent are unavailable.");
                ec++
            }
        }
    }
    ...
    function lc(a, b, d, e, g) {
        if (ca(b)) for (var h = 0; h < b.length; h++) lc(a, b[h], d, e, g); else (d = gc(d), a && a[Vb]) ? (a = a.D, b = String(b).toString(), b in a.c && (h = a.c[b], d = ac(h, d, e, g), -1 < d && (Yb(h[d]), B.splice.call(h, d, 1), 0 == h.length && (delete a.c[b], a.f--)))) : a && (a = hc(a)) && (b = a.c[b.toString()], a = -1, b && (a = ac(b, d, !!e, g)), (d = -1 < a ? b[a] : null) && mc(d))
    }

    function mc(a) {
        if (!ea(a) && a && !a.N) {
            var b = a.src;
            if (b && b[Vb]) bc(b.D, a); else {
                var d = a.type, e = a.c;
    ...
    function nc(a, b, d, e) {
        var g = !0;
        if (a = hc(a)) if (b = a.c[b.toString()]) for (b = b.concat(), a = 0; a < b.length; a++) {
            var h = b[a];
    ...
    function kc(a, b) {
        ...
        if (!Qb) {
            ...
            if (!(d = b)) a:{
                d = ["window", "event"];
                for (var e = p, g; g = d.shift();) if (null != e[g]) e = e[g]; else {
                    d = null;
                    break a
                }
                d = e
            ...
            if (!(0 > g.keyCode || void 0 != g.returnValue)) {
                ...
                for (var h = a.type, l = g.length - 1; 0 <= l; l--) {
                    d.c = g[l];
                    var m = nc(g[l], h, !0, d), e = e && m
                }
                for (l = 0; l < g.length; l++) d.c = g[l], m = nc(g[l], h, !1, d),
                    e = e && m
            }
            return e
        }
    ...
    function K(a, b) {
        ...
        var e = a.da, g = b, h = g.type || g;
        if (t(g)) g = new Sb(g, e); else if (g instanceof Sb) g.target = g.target || e; else {
            var k = g, g = new Sb(h, e);
            Ga(g, k)
        }
        var k = !0, l;
    ...
    function rc(a, b, d) {
        if (u(a)) d && (a = v(a, d)); else if (a && "function" == typeof a.handleEvent) a = v(a.handleEvent, a); else throw Error("Invalid listener argument");
    ...
    function zc(a, b) {
        if ("function" == typeof a.forEach) a.forEach(b, void 0); else if (da(a) || t(a)) sa(a, b, void 0); else {
            var d;
            if ("function" == typeof a.I) d = a.I(); else if ("function" != typeof a.J) if (da(a) || t(a)) {
                d = [];
    ...
    var Jc = new Ic("SEVERE", 1E3), Kc = new Ic("WARNING", 900), Lc = new Ic("INFO", 800), Mc = new Ic("CONFIG", 700),
        Nc = new Ic("FINE", 500);
    ...
    Hc.prototype.log = function (a, b, d) {
        if (a.value >= Oc(this).value) for (u(b) && (b = b()), a = new Fc(a, String(b), this.i), d && (a.c = d), d = "log:" + a.f, p.console && (p.console.timeStamp ? p.console.timeStamp(d) : p.console.markTimeline && p.console.markTimeline(d)), p.msWriteProfilerMark && p.msWriteProfilerMark(d), d = this; d;) d = d.f
    };
    var Pc = {}, Qc = null;
    ...
    function Rc(a) {
        ...
        if (!(b = Pc[a])) {
            b = new Hc(a);
            var d = a.lastIndexOf("."), e = a.substr(d + 1), d = Rc(a.substr(0, d));
            d.h || (d.h = {});
            d.h[e] = b;
            b.f = d;
            Pc[a] = b
    ...
    function ad(a, b) {
        for (var d = a.split("&"), e = 0; e < d.length; e++) {
            var g = d[e].indexOf("="), h = null, k = null;
    ...
    x(cd, I);
    var dd = "", ed = cd.prototype, fd = Rc("goog.net.XhrIo");
    ed.v = fd;
    var gd = /^https?$/i, hd = ["POST", "PUT"], id = [];
    ...
    function pd(a) {
        if (a.f && "undefined" != typeof aa) if (a.H[1] && 4 == qd(a) && 2 == a.w()) L(a.v, M(a, "Local request error detected and ignored")); else if (a.s && 4 == qd(a)) rc(a.ha, 0, a); else if (K(a, "readystatechange"), 4 == qd(a)) {
            L(a.v, M(a, "Request complete"));
            a.f = !1;
            try {
                if (rd(a)) K(a, "complete"), K(a, "success"); else {
                    var b;
                    try {
    ...
    function Gd(a, b) {
        ...
        var d = a, e = b, g = d.clone(), h = !!e.i;
        h ? td(g, e.i) : h = !!e.o;
        h ? g.o = e.o : h = !!e.c;
        h ? g.c = e.c : h = null != e.s;
        var k = e.f;
        if (h) ud(g, e.s); else if (h = !!e.f) if ("/" != k.charAt(0) && (d.c && !d.f ? k = "/" + k : (d = g.f.lastIndexOf("/"), -1 != d && (k = g.f.substr(0, d + 1) + k))), d = k, ".." == d || "." == d) k = ""; else if (A(d, "./") || A(d, "/.")) {
    ...
    n.I = function () {
        Id(this);
        for (var a = this.c.J(), b = this.c.I(), d = [], e = 0; e < b.length; e++) for (var g = a[e], h = 0; h < g.length; h++) d.push(b[e]);
        return d
    };
    n.J = function (a) {
        Id(this);
    ...
    n.toString = function () {
        ...
        if (!this.c) return "";
        for (var a = [], b = this.c.I(), d = 0; d < b.length; d++) for (var e = b[d], g = encodeURIComponent(String(e)), e = this.J(e), h = 0; h < e.length; h++) {
            var k = g;
    ...
    function Rd(a, b) {
        var d = Qd();
        if (d) if (a && b) d.ServicePort = a, d.ServiceHost = b; else try {
            delete d.ServicePort, delete d.ServiceHost
        } catch (e) {
        } else Nd() ? a && b ? (Od("ServicePort", a, 100), Od("ServiceHost", b, 100)) : (Od("ServicePort", "", 100), Od("ServiceHost", "", 100)) : (window.f = a, window.c = b)
    }

    function Sd() {
        var a = Qd();
        return a ? {Port: a.ServicePort, Host: a.ServiceHost} : Nd() ? {
            Port: Pd("ServicePort"),
            Host: Pd("ServiceHost")
    ...
    function Wd(a, b) {
        ...
        var g = g || 41951, e = e || "127.0.0.1", h = "127.0.0.1" === e;
    ...
    function $d(a, b, d) {
        var e = Sd(), g = "https://" + e.Host + ":" + e.Port + "/DYMO/DLS/Printing/" + b;
    ...
    function be() {
        ...
        this.printLabel = function (a, b, d, e) {
            return ae("POST", "PrintLabel", {printerName: a, printParamsXml: b, labelXml: d, labelSetXml: e})
        };
        this.printLabel2 = function (a, b, d, e) {
            return ae("POST", "PrintLabel2", {printerName: a, printParamsXml: b, labelXml: d, labelSetXml: e})
        };
        ...
        this.X = function (a, b, d, e) {
            return $d("POST", "PrintLabel", {printerName: a, printParamsXml: b, labelXml: d, labelSetXml: e})
        };
        this.W = function (a, b, d, e) {
            return $d("POST", "PrintLabel2", {printerName: a, printParamsXml: b, labelXml: d, labelSetXml: e})
        };
    ...
    function je(a) {
        for (var b = R("<LabelSet/>"), d = b.documentElement, e = 0; e < a.length; e++) {
            var g = a[e], h = b.createElement("LabelRecord"), k;
            for (k in g) {
                var l = g[k];
                if ("function" != typeof l) {
                    var l = l.toString(), m = b.createElement("ObjectData");
...
*/
    ...
    ye.prototype.cancel = function (a) {
        if (this.c) this.h instanceof ye && this.h.cancel(); else {
            if (this.f) {
                var b = this.f;
                delete this.f;
    ...
    function Ce(a) {
        ...
        for (var b = a.h, e = d = !1; a.l.length && !a.o;) {
            var g = a.l.shift(), h = g[0], k = g[1], g = g[2];
            if (h = a.i ? k : h) try {
    ...
    function Ie(a, b) {
        var d = b || {}, e = d.document || document, g = document.createElement("SCRIPT"), h = {ja: g, L: void 0},
            k = new ye(Je, h), l = null, m = null != d.timeout ? d.timeout : 5E3;
    ...
    Pe.prototype.send = function (a, b, d, e) {
        ...
        var g = this.f.clone();
        if (a) for (var h in a) if (!a.hasOwnProperty || a.hasOwnProperty(h)) {
            var k = g, l = h, m = a[h];
            ca(m) || (m = [String(m)]);
            Md(k.h, l, m)
        }
    ...
    function nf(a, b) {
        var d = a.h(), e = a.f, g = a.c.C;
        (new Pe(Gd(g, "getPrintJobStatus"), "callback")).send({jobId: e, printerName: a.c.c}, function (a) {
    ...
    pf.prototype.getPrinters = function () {
        var a = qf(this.h), b = new N(this.c), d = this.f;
        "" == d && (d = b.c);
    ...
    w("dymo.label.framework.addPrinterUri", function (a, b, d, e) {
        ...
        var h = bd(a);
        (new Pe(h, "callback")).send(null, function (b) {
            of[a] = new pf(a, g, b);
            d && d(a)
        }, b)
    });
    ...
    function me(a, b, d, e) {
        ...
        var g = uf()[a];
        if (null != g) "" != g.C ? yf(g, b, d, e) : P().printLabel(g.name, b, d, e); else throw Error("printLabel(): unknown printer '" + a + "'");
    }
    ...
    function yf(a, b, d, e) {
        function g(a, b) {
            ...
            (new Pe(k, "c")).send({j: h, cid: a, pl: e}, function (d) {
                var e = d.status, k = new Hc("dymo.label.framework");
                k.c = Lc;
